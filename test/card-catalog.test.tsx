...
describe('card catalog assets and presentation', () => {
  ...
  it('groups every card in family, cost, and name order', () => {
    ...
    expect(actual).toEqual([
      ...
      { heading: 'Melee', cards: ['Jab:3', 'Opening Strike:3', 'Strike:3', 'Bull Rush:4', 'Drive:4', 'Rally:4', 'Feint:5', 'Flurry:5', 'Heavy Blow:5'] },
      { heading: 'Ranged', cards: ['Peppering Shot:3', 'Repelling Shot:3', 'Steady Shot:3', 'Longshot:4', 'Salvage Shot:4', 'Aim:5', 'Precision Shot:5', 'Volley:5'] },
