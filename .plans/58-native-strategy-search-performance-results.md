...
A three-shard-per-stage, 20,000-candidate product validation completed in 2.586 seconds: stage one 1.144 seconds, stage two 1.112 seconds, generated-ID digest `a15c52fe445bf`, canonical provenance digest `1d332df83ca967`. Both stages record contiguous shard provenance and full candidate and score digests. A real stateful-generator test scores real candidates and proves one-process equality for generated provenance, prefilter order, four-seed leader order, and final tail order across uneven shards. The earlier 52,000-candidate bounded validation remains valid evidence for capacity and artifact size.
