...
These documents are superseded. Do not use them for current product or implementation decisions. Their bodies remain unchanged so they preserve the project history.

| Document | Current replacement |
| --- | --- |
| `01-interactive-human-vs-ai.md` through `07-fast-local-play-ui.md`, including both `03` documents | `../12-repository-cleanup.md` for the local two-player product and repository scope; `../09-card-list.md` for current rules |
| `10-1-card-batch.md` through `10-8-profiling.md` | `../10-automated-balance-search.md` and `../11-search-performance.md` |
| `balance-search-goal.md` | `../10-automated-balance-search.md`, `../11-search-performance.md`, and `../12-repository-cleanup.md` |
| `balance-search-progress.md` | `../10-automated-balance-search.md`, `../11-search-performance.md`, and current source and tests |
