...
export function createGame(config: number | CreateGameConfig): GameState {
  ...
  return {
    ...
    kingdomId: FIRST_MARKET.id, startingHealth,
    ...
    fighters: {
      ochre: { playerId: 'ochre', position: 2, health: startingHealth, aimed: false, exposed: false },
      indigo: { playerId: 'indigo', position: 3, health: startingHealth, aimed: false, exposed: false }
    },
