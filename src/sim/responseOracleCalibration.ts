...
export const RESPONSE_ORACLE_CALIBRATION_TARGETS = Object.freeze({
  'deep-beam-tuning-001': { runId: 'native-541cb83d1e13-568cb4cd8181f5088168',
    reservoirSha256Prefix: '4357b70' },
  'deep-beam-tuning-007': { runId: 'native-1552de33e3cb-ca0b9ed1a6ebdcd051e0',
    reservoirSha256Prefix: '17a1e34' },
  'deep-beam-tuning-008': { runId: 'native-1552de33e3cb-a9c81e98dcc9d46d5ce5',
    reservoirSha256Prefix: '56380c6' }
} as const);
...
function validateSourceIdentity(source: CalibrationSourceIdentity): void {
  ...
  if (!target || source.reservoirRunId !== target.runId
    || !source.reservoirSha256.startsWith(target.reservoirSha256Prefix)
