import {
  ALWAYS_AVAILABLE_ACTION_IDS, ALWAYS_AVAILABLE_COUNT, ARENA_MAX, ARENA_MIN, cardDefinition, firstBuyCarry,
  isTacticalAction, kingdomEpoch, kingdomMarket, kingdomOf, playerStartingHealth
} from '../game';
