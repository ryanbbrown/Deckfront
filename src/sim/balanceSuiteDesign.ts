...
const AUTHORED_ROWS: readonly DesignRow[] = Object.freeze([
  ...
  { ...authored('tuning', 'strategy-search-continuity-anchor', 'strategy-search-continuity-anchor',
    'Strategy-search continuity anchor',
    ['channel', 'improvise', 'longshot', 'precisionShot', 'reclaim', 'reforge', 'salvageShot', 'scour', 'sharpen', 'strike']),
    provenance: { kind: 'authored', rationaleId: 'strategy-search-continuity-anchor',
      reason: 'Strategy-search continuity anchor', sourceId: 'strategy-search-continuity-anchor',
      sourceDigest: '4e7c9c889fc40b7d52532b756f17121a247d91497ac0e49f9acd7a150a0972a6' } },
