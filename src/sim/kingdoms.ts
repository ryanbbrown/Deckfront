/**
 * The four hand-built diagnostic kingdoms. `distance-duel` is the browser default and is deliberately absent: it is a shipped market,
...
export const CURATED_KINGDOM_IDS: readonly string[] = Object.freeze([
  'current-duel', 'three-way-open', 'three-way-engine', 'range-rich-mixed'
]);
