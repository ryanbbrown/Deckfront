      ...
      <div className="instructions-dialog__content">
        ...
        <section className="instructions-range" aria-labelledby="instructions-range-title">
          ...
          <div className="range-rules">
            ...
            <article className="range-rule range-rule--mana"><span aria-hidden="true">✦</span><div><h4>Mage · Any range</h4><p>Cast spells from any position on the battlefield.</p></div></article>
          </div>
        </section>
      </div>
