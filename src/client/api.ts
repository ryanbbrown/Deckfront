...
export function createGame(input: { seed?: number; strategyPresetId: string; strategyMarkdown: string; firstPlayerId: PlayerId }): Promise<SafeGameView> { return request('/api/games', { method: 'POST', body: JSON.stringify(input) }); }
