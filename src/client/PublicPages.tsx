...
function AboutContent() {
  return <article className="public-article">
    ...
    <section><h2>What is coming</h2><ul><li>Online multiplayer.</li><li>Player accounts and profiles.</li><li>New markets outside the selected 160, with matching AI opponents.</li><li>Mobile layouts.</li></ul></section>
  </article>;
}
