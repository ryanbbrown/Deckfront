...
const root = '.games/e002-center-vs-flank-a';
...
const unitDefs = JSON.parse(await readFile('rulesets/territory-v1/units.json', 'utf8'));
...
const turns = [
  {
    ...
    reasoning:
      'P1 thinned a Rest, used Zap and Bandage for a small damage/heal turn with no legal target, and declined Copper. The raider and scout took the two nearby centers while the slower core stayed compact.',
    moves: [
      ['P1-raider-1', 8, 1],
      ['P1-scout-1', 10, 3],
      ['P1-guardian-1', 10, 2],
  ...
  },
  {
    ...
    reasoning:
      'P2 had no useful deck counters, so the board plan emphasized safe captures and support development. The druid moved behind the lead scout rather than contesting center immediately.',
    moves: [
      ['P2-scout-1', 3, 7],
      ['P2-scout-2', 2, 9],
      ['P2-druid-1', 2, 7],
  ...
  },
  {
    ...
    reasoning:
      'The central scout flip followed the assigned compact-center plan but left the scout exposed. P1 spent the first 5 supply on a marksman rather than a scout to reinforce the core.',
    moves: [
      ['P1-scout-1', 7, 3],
      ['P1-raider-1', 6, 2],
      ['P1-guardian-1', 9, 2],
  ...
  },
  {
    ...
    reasoning:
      'P1 bought toward tactical damage and kept the formation compact enough that P2 could not isolate a single high-value unit yet.',
    moves: [
      ['P1-scout-1', 5, 3],
      ['P1-raider-1', 6, 4],
      ['P1-guardian-1', 8, 2],
  ...
  },
  {
    ...
    reasoning:
      'P2’s southern scout took the southeast center while the marksman supported from behind. Deck and unit damage were assigned only through legal attacks, preserving the least-expansive damage interpretation.',
    moves: [
      ['P2-scout-1', 9, 7],
      ['P2-scout-2', 6, 6],
      ['P2-druid-1', 4, 7],
    ...
    attacks: [{ attacker: 'P2-scout-2', target: 'P1-raider-1', bonus: 1 }]
  },
  {
    id: 'turn-007',
    summary: 'P1 took the exact middle, bloodied the forward southern scout, and added a guardian.',
    reasoning:
      'Center control stayed plausible: P1’s upgraded guardian moved into the middle while the raider punished the closest flank scout. The recruit favored durability over speed.',
    moves: [
      ['P1-guardian-1', 7, 2],
      ['P1-raider-1', 6, 5],
      ['P1-scout-1', 5, 4],
  ...
  },
  {
    ...
    reasoning:
      'The southeast scout forced P1 to split. P2’s raider and marksman attacked the exposed center scout while the healer and druid moved into a support pocket.',
    moves: [
      ['P2-scout-1', 10, 3],
      ['P2-druid-1', 5, 8],
      ['P2-marksman-1', 5, 6],
    ...
    attacks: [{ attacker: 'P2-marksman-1', target: 'P1-scout-1', bonus: 1 }]
  },
  {
    id: 'turn-011',
    ...
    attacks: [
      { attacker: 'P1-guardian-2', target: 'P2-scout-1', bonus: 1 },
  ...
  {
    id: 'turn-013',
    summary: 'P1 used the upgraded center guardian to kill P2’s support marksman and recruited another guardian.',
    reasoning:
      'P1’s center mass converted into a kill, but the raider that made the punish survived. P1’s supply lead turned into another durable body.',
    moves: [
      ['P1-guardian-1', 6, 5],
      ['P1-marksman-1', 6, 4],
      ['P1-guardian-2', 10, 3],
    ...
    attacks: [
      { attacker: 'P1-guardian-1', target: 'P2-marksman-1', bonus: 2 },
  ...
  },
  {
    ...
    reasoning:
      'P1’s center control looked strong, with a unit-count and center-count lead, and Training finally upgraded the lead guardian. The formation was now broad rather than compact. The run stopped after P1’s 8th turn because the central-control plan led but had not resolved under the start-of-turn win condition.',
    moves: [
      ['P1-guardian-1', 6, 5],
      ['P1-marksman-1', 6, 4],
      ['P1-guardian-2', 9, 3],
...
let timeline = { schemaVersion: 1, title: 'E002 Center vs Flank A', entries: [] };
...
function runCli(turnId, actionCount) {
  const result = spawnSync('bun', [
    ...
    'src/cli/main.ts',
    '--config',
    'rulesets/territory-v1/deck.yaml',
    '--state',
    deckPath,
    '--script',
