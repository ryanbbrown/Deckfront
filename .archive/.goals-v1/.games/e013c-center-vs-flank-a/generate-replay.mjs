...
const starterBoard = JSON.parse(await readFile(join(repoRoot, '.games/e013-contest-starter.board.json'), 'utf8'));
...
const turns = [
  ...
  },
  {
    ...
    summary: 'P1 killed the east scout and recruited a druid to sustain the center.',
    reasoning:
  ...
  },
  {
    ...
    summary: 'P1 killed the wounded lower raider and recruited a healer for staying power.',
    reasoning:
