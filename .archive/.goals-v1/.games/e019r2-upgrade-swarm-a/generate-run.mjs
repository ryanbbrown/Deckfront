...
const TITLE = 'E019 R2 upgrade/support vs swarm/economy A strict';
...
for (let turnNumber = 1; turnNumber <= 90; turnNumber += 1) {
...
async function writeNotes() {
  ...
  const lines = [
    '# E019 R2 Upgrade/Support vs Swarm/Economy A',
    '',
    ...
    '- P1 followed an upgrade/support plan with higher recruit throughput than round 1: Armory and Training still created anchors, but saved supply was spent more aggressively on marksmen, scouts, and support bodies to contest centers.',
