...
const runDir = '.games/e014c-upgrade-vs-swarm-a';
...
async function main(): Promise<void> {
  ...
  const timeline: { schemaVersion: 1; title: string; entries: ReplayEntry[] } = {
    schemaVersion: 1,
    title: 'E014c upgrade/support vs swarm/economy A tempo replay',
    entries: []
  };
  seedCounters(board);
  ...
  const notes = `# E014c Upgrade/Support vs Swarm/Economy A Notes
