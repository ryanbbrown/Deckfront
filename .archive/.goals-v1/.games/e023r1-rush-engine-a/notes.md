...
- Late center-majority threats are checked only at start-of-turn after at least 24 completed player turns. This run records pending/cleared center-majority state in each timeline entry's reasoning. In this sample, the game resolved by unit count before any center-majority confirmation.
