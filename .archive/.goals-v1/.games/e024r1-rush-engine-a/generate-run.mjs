...
const root = '.games/e024r1-rush-engine-a';
...
await writeFile(join(root, 'timeline.json'), `${JSON.stringify({ schemaVersion: 1, title: 'E024 round 1 rush vs engine A strict high-movement six-center dominance', entries }, null, 2)}\n`);
...
async function writeNotes() {
  ...
  const text = `# E024 Round 1 Rush Vs Engine A
