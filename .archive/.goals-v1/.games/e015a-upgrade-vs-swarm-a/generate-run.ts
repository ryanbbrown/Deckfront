...
const runDir = '.games/e015a-upgrade-vs-swarm-a';
...
async function main(): Promise<void> {
  ...
  const timeline: { schemaVersion: 1; title: string; entries: ReplayEntry[] } = {
    schemaVersion: 1,
    title: 'E015a upgrade/support vs swarm/economy A compressed replay',
    entries: []
  };
  seedCounters(board);
  ...
  const notes = `# E015a Upgrade/Support vs Swarm/Economy A Notes
