...
const TITLE = 'E024b R2 six-center stress C strict high-movement six-center tight deficit';
...
async function writeNotes() {
  ...
  const lines = [
    ...
    '- P1 followed an upgrade/support center-denial plan: Armory and Training created anchors while saved supply was spent on marksmen, scouts, and support bodies to contest centers.',
    '- P2 followed swarm/economy territory-rush priorities: Silver, Gold, Peddler, and Village fueled steady broad recruitment and multi-center pressure, with movement biased toward six-center control.',
    ...
    winner
      ? '- The important tension was whether late six-center dominance could resolve a support-versus-swarm replacement loop below 50 turns and whether P1 could clear by flipping a center or moving 2 units ahead under E024b.'
      : '- The important tension was whether late six-center dominance could resolve a support-versus-swarm replacement loop below 50 turns and whether P1 could clear by flipping a center or moving 2 units ahead under E024b.',
    '',
    'Win-window log:',
    ...notes.map((note) => `- ${note}`)
