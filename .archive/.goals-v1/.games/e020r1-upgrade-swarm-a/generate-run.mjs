...
const TITLE = 'E020 R1 upgrade/support vs swarm/economy A strict';
...
const starterBoard = JSON.parse(await readFile(join(ROOT, '.games', 'e020-recenter-starter.board.json'), 'utf8'));
...
async function writeNotes() {
  ...
  const lines = [
    '# E020 R1 Upgrade/Support vs Swarm/Economy A',
    '',
    ...
    '',
    'Legality notes:',
    '- Generated from the assigned E020 recentered starter with explicit strict action logs for movements, recruits, and attacks.',
