...
const TITLE = 'E021 R1 upgrade/support vs swarm/economy A strict no-printheal';
...
const UNIT_RULES = {
  ...
  druid: { attack: 4, hp: 10, movement: 1, range: 1, heal: 0 },
  healer: { attack: 1, hp: 4, movement: 1, range: 2, heal: 0 }
};
...
const starterBoard = JSON.parse(await readFile(join(ROOT, '.games', 'e021-recenter-no-printheal-starter.board.json'), 'utf8'));
...
async function writeNotes() {
  ...
  const lines = [
    '# E021 R1 Upgrade/Support vs Swarm/Economy A',
    '',
    ...
    '',
    'Legality notes:',
    '- Generated from the assigned E021 recentered no-print-heal starter with explicit strict action logs for movements, recruits, and attacks.',
    ...
    '- Druid and healer printed healing are disabled; only deck-produced healing and upgradeHealth healing are applied.',
