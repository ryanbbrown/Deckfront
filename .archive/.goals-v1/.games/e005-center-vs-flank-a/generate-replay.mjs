...
const root = '.games/e005-center-vs-flank-a';
...
const turns = [
  ...
  },
  {
    ...
    reasoning:
      'P1’s center control looked strong, with a unit-count and center-count lead, and Training upgraded the newest guardian in the east response group. The formation was now broad rather than compact, giving P2 a live flank response rather than an immediate start-of-turn loss.',
    moves: [
      ['P1-guardian-1', 6, 5],
      ['P1-marksman-1', 6, 4],
      ['P1-guardian-2', 9, 3],
  ...
  {
    id: 'turn-016',
    summary: 'P2 used the access lanes to reload the flank and force one more split from P1 instead of conceding the center.',
    reasoning:
      'P2 had no start-of-turn win check, but income from three southern centers plus saved supply funded a full home-base wave. The forward raider moved through the center-south lane to hit P1’s lead guardian, while the scout moved up the west lane toward northwest pressure. This stopped short of resolution but preserved the intended center/flank tension after both players had eight turns.',
    moves: [
      ['P2-raider-1', 6, 6],
      ['P2-druid-1', 5, 7],
      ['P2-healer-1', 4, 6],
    ...
    recruits: [
      ['P2-scout-4', 'scout', 0, 8],
      ['P2-healer-2', 'healer', 1, 7]
    ]
  }
];
...
let timeline = { schemaVersion: 1, title: 'E005 Center vs Flank A', entries: [] };
