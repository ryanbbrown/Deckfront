...
const root = '.games/e020r1-rush-engine-a';
...
await writeFile(join(root, 'timeline.json'), `${JSON.stringify({ schemaVersion: 1, title: 'E020 round 1 rush vs engine A strict recenter', entries }, null, 2)}\n`);
...
async function writeNotes() {
  ...
  const text = `# E020 Round 1 Rush Vs Engine A
