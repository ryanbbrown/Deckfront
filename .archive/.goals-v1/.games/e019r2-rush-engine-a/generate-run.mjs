...
const root = '.games/e019r2-rush-engine-a';
...
await writeFile(join(root, 'timeline.json'), `${JSON.stringify({ schemaVersion: 1, title: 'E019 round 2 rush vs engine A strict', entries }, null, 2)}\n`);
...
async function writeNotes() {
  ...
  const text = `# E019 Round 2 Rush Vs Engine A
