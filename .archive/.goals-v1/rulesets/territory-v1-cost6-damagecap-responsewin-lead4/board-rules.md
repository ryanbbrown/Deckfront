# Territory V1 Cost 6 Damage Cap Response Win Lead 4 Rules

This is a win-threshold variant of `territory-v1-cost6-damagecap-responsewin` for E012 playtests. It keeps the same cards, units, map, timing, recruit cost 6, deck-damage cap, and response-window timing, but requires a 4-unit lead to create and confirm a unit-count win threat.
...
- Deck config: `rulesets/territory-v1-cost6-damagecap-responsewin-lead4/deck.yaml`
