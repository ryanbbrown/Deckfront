# Territory V1 Cost 6 Rules

This is a recruit-cost variant of `territory-v1-locked` for E006 playtests. It keeps the same cards, units, timing, and map assumptions, but increases recruitment cost from 5 to 6 supply to slow supply-to-body snowball.
...
- Deck config: `rulesets/territory-v1-cost6/deck.yaml`
...
The initial deck is fixed for this cost-6 variant: each player starts with 7 Coppers plus up to 12 coin to draft additional starting cards before turn 1. Unspent draft coin does not carry over in E006 cost-6 runs.
