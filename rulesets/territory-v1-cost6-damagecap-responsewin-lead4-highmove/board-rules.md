# Territory V1 Cost 6 Damage Cap Response Win Lead 4 High Movement Rules

This is a high-movement diagnostic variant of `territory-v1-cost6-damagecap-responsewin-lead4` for E022 playtests. It keeps the same cards, timing, recruit cost 6, normal income, deck-damage cap, and lead-4 response-window win condition, but substantially increases every unit's movement to test whether more board churn reduces clumping and long conversion grinds.

## Source Files

- Map: `maps/sketch-v5-recenter.json`
- Sample run state: `.games/territory-v1-playtest/board.json`
- Units: `rulesets/territory-v1-cost6-damagecap-responsewin-lead4-highmove/units.json`
- Deck config: `rulesets/territory-v1-cost6-damagecap-responsewin-lead4-highmove/deck.yaml`
...
The initial deck is fixed for this high-movement damage-cap variant: each player starts with 7 Coppers plus up to 12 coin to draft additional starting cards before turn 1. Unspent draft coin does not carry over in E022 runs.
...
Units start at their max HP and use the high-movement values from `rulesets/territory-v1-cost6-damagecap-responsewin-lead4-highmove/units.json`.
