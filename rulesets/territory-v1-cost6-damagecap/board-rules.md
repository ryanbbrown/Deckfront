# Territory V1 Cost 6 Damage Cap Rules

This is a damage-tempo variant of `territory-v1-cost6` for E007 playtests. It keeps the same cards, units, map, timing, and recruit cost 6, but caps deck-produced damage so one attacker cannot carry a whole burst into a single kill.
...
- Deck config: `rulesets/territory-v1-cost6-damagecap/deck.yaml`
